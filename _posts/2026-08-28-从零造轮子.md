...
description: "读后整理 build-your-own-x 教程仓库：500+ 教程教你从零复刻经典技术，从操作系统到正则引擎，从区块链到文本编辑器。附经典教程精选与新手路线。"
summary: "整理自 codecrafters 的 build-your-own-x 仓库：30 个分类、500+ 篇分步教程。从入门友好的 kilo 编辑器、500L 系列，到硬核的数据库、操作系统、编译器等系统级项目，并附'从小到大、从近到远'的学习路线与几条建议。"
