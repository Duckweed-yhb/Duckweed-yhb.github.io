...
layout: post          
title:  "C 语言学习笔记"
description: "{% raw %} <!-- 开启Liquid忽略，避免Jekyll解析代码中的{} --"
...
"合抱之木，生于毫末。" C 语言常是很多工科同学的第一门语言。我把最核心的语法整理成 8 章，每章附可直接运行的代码和常见易错点，供你入门和复习时随手翻看。
...
编程的路上，慢即是快。把这 8 章亲手敲一遍，指针和结构体就不再是拦路虎。
